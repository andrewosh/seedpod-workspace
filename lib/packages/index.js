...
PackageManager.prototype.export = async function (version) {
  let manifestPath = version ? naming.localVersionManifest(version) : naming.localManifest()
  let interfacePath = version ? naming.localVersionInterface(version) : naming.localInterface()
  let schemaPath = version ? naming.localVersionSchema(version) : naming.localSchema()
  let typeIndexPath = version ? naming.localVersionTypeIndex(version) : naming.localTypeIndex()
