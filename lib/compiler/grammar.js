...
var grammar = {
    ...
    {"name": "Field", "symbols": ["Field$subexpression$1", "Field$subexpression$2", "Space"], "postprocess": 
        ([[fieldName], [fieldType]]) => {
          return {
    ...
    {"name": "SparqlQuery", "symbols": [(lexer.has("sparql") ? {type: "sparql"} : sparql), (lexer.has("queryName") ? {type: "queryName"} : queryName), "QueryArgs", (lexer.has("colon") ? {type: "colon"} : colon), "QueryReturn", "LeftBrace", "QueryBody"], "postprocess": 
        ([, name, args, , type, , body]) => {
          return {
            nodeType: 'sparql',
            name: name.value,
    ...
    {"name": "QueryArgs$ebnf$1", "symbols": ["QueryArgs$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "QueryArgs$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "QueryArgs", "symbols": [(lexer.has("leftparen") ? {type: "leftparen"} : leftparen), "QueryArgs$ebnf$1", (lexer.has("rightparen") ? {type: "rightparen"} : rightparen)], "postprocess": 
        ([, params, ]) => {
    ...
    {"name": "QueryArg", "symbols": ["QueryArg$subexpression$1", "QueryArg$subexpression$2"], "postprocess": 
        ([[name], [type]]) => {
          return {
            paramName: {
    ...
    {"name": "QueryReturn", "symbols": [(lexer.has("arrayQueryType") ? {type: "arrayQueryType"} : arrayQueryType)], "postprocess": 
        ([type]) => {
         return {
    ...
    {"name": "QueryBody", "symbols": ["QueryBody$ebnf$1", (lexer.has("queryBodyClose") ? {type: "queryBodyClose"} : queryBodyClose), "QueryBody$ebnf$2"], "postprocess": 
